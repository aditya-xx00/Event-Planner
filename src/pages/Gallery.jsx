...
const Gallery = () => {
    const images = [
        "https://images.unsplash.com/photo-1519225468359-69df963968bf?auto=format&fit=crop&w=800&q=80",
        "https://images.unsplash.com/photo-1464349153912-6b4b412f26b5?auto=format&fit=crop&w=800&q=80",
        ...
        <div className="bg-primary min-h-screen py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h1 className="text-4xl font-extrabold text-accent sm:text-5xl font-serif mb-4">Our Gallery</h1>
                ...
                <div className="columns-1 md:columns-2 lg:columns-3 gap-4 space-y-4">
                    {images.map((src, idx) => (
                        <div key={idx} className="break-inside-avoid rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                            <img
                                src={src}
                                alt={`Gallery ${idx + 1}`}
