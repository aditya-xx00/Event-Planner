                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-4 pt-2">
                            ...
                            <a href="https://wa.me/919044201220" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-secondary transition-colors"><WhatsAppIcon className="h-5 w-5" /></a>
