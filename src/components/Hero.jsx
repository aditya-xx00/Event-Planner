        ...
        <div className="relative bg-primary overflow-hidden">
            <div className="max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="order-2 lg:order-1" data-aos="fade-up" data-aos-offset="200" data-aos-delay={1 * 50}>
                        <img
                    ...
                    <div className="order-1 lg:order-2 px-4 sm:px-6 lg:px-8 py-12 lg:py-24">
                        ...
                        <p className="mt-6 text-base sm:mt-6 sm:text-lg md:mt-8 md:text-lg font-light" style={{ color: "#190A40" }} data-aos="fade-up">
                        ...
                        <div className="mt-5 sm:mt-8 flex flex-col sm:flex-row gap-5 justify-center" data-aos="fade-up" data-aos-offset="200">
                            <Link
                                to="/booking"
